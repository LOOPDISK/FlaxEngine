    ...
    public class EditorViewport : RenderOutputControl
    {
        ...
        private static readonly ViewModeOptions[] ViewModeValues =
        {
            ...
            new ViewModeOptions("GBuffer", new[]
            {
                ...
                new ViewModeOptions(ViewMode.ClearcoatIntensity, "Clearcoat Intensity"),
                new ViewModeOptions(ViewMode.ClearcoatRoughness, "Clearcoat Roughness"),
                new ViewModeOptions(ViewMode.ClearcoatNormal, "Clearcoat Normal"),
