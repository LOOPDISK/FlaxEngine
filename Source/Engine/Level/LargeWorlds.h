...
API_CLASS(Static) class FLAXENGINE_API LargeWorlds
{
    ...
    /// </summary>
    API_FIELD() static constexpr Real ChunkSize = 32; // 8192; // TODO: ideally this would be 0 (although it would need to be hand inlined to prevent divide by 0), but below the value of 32 causes artifacts with volumetric fog.
